...
?>
Ensure Correct Namespacing and Autoloading:
Make sure the namespaces and autoloading are correctly set up. This usually involves having a proper composer.json file and running composer dump-autoload.

Update insert.php:
With the class definitions corrected, here's the final version of insert.php:
